...
-- Run this in Supabase SQL Editor if migration didn't seed the data

-- Clear existing data (optional)
-- DELETE FROM public.crisis_resources;
...
ON CONFLICT (country_code) DO UPDATE SET
  ...
  nhs_mental_health = EXCLUDED.nhs_mental_health,
  primary_crisis_line = EXCLUDED.primary_crisis_line,
...
SELECT country_code, country_name FROM public.crisis_resources ORDER BY country_name;
